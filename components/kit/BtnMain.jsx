// figma node: 137:1199 Btn-Main (2 variants)
const __venc = (v) => String(v).replace(/[%|=]/g, encodeURIComponent);
const __vkey = (p) => "state=" + __venc(p.state);

export function BtnMain(_p = {}) {
  const props = { ..._p, state: _p.state ?? "off" };
  const __body0 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
        ...
        <svg width={52.500} height={55.417} viewBox="0 0 52.500 55.417" fill="none" style={{
          position: "absolute",
          left: 8.75,
          top: 5.833,
          width: 52.5,
